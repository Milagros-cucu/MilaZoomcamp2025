...
BUCKET_NAME = "dezoomcamp_module4"

# If you authenticated through the GCP SDK you can comment out these two lines
CREDENTIALS_FILE = "dbt-bigquery-service-account-credential.json"
client = storage.Client.from_service_account_json(CREDENTIALS_FILE)
# If commented initialize client with the following
# client = storage.Client(project='zoomcamp-mod3-datawarehouse')

# BASE_URL = "https://github.com/DataTalksClub/nyc-tlc-data/releases/download/yellow/yellow_tripdata_2019-"
BASE_URL = "https://github.com/DataTalksClub/nyc-tlc-data/releases/download/green/green_tripdata_2019-"

MONTHS = [f"{i:02d}" for i in range(1, 11)]
DOWNLOAD_DIR = "."
...
#    file_path = os.path.join(DOWNLOAD_DIR, f"yellow_tripdata_2019-{month}.csv.gz")
